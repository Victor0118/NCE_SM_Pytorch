...
def run(device, epochs, neg_sample, neg_num, dataset, dev_log_interval):
    param_gen = get_param()
...
if __name__ == '__main__':
    ...
    run(args.device, args.epochs, neg_sample=args.neg_sample, neg_num=args.neg_num, dataset=args.dataset, dev_log_interval=args.dev_log_interval)